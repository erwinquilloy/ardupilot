...
circle around the target waypoint. The pitch stick now adjusts
altitude during this loiter phase the same way FBW-B does it — pull
the stick up to climb, push down to descend — so the pilot can settle
