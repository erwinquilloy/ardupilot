...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Description: Maximum bank angle in degrees during the initial RTL climb (RTL_CLIMB_MIN m above start). Separate from LEVEL_ROLL_LIMIT (used for takeoff/landing) so the climb-out can be more relaxed without softening takeoff/landing leveling.
    // @Units: deg
    // @Range: 0 45
    // @Increment: 1
    // @User: Standard
    GSCALAR(rtl_level_roll_limit,          "RTL_LVL_RLL_LMT",   5),
    ...
    // @Description: Loiter radius (m) used during the emergency-landing sink and glide phases (overrides RTL_RADIUS). 0 = use RTL_RADIUS as normal. Smaller radius descends faster but may overshoot the home location in strong wind.
    // @Units: m
    // @Range: 0 600
    // @Increment: 1
    // @User: Standard
    ...
    // @Values: 0:Manual,1:CIRCLE,2:STABILIZE,3:TRAINING,4:ACRO,5:FBWA,6:FBWB,7:CRUISE,8:AUTOTUNE,10:Auto,11:RTL,12:Loiter,13:TAKEOFF,14:AVOID_ADSB,15:Guided,17:QSTABILIZE,18:QHOVER,19:QLOITER,20:QLAND,21:QRTL,22:QAUTOTUNE,23:QACRO,24:THERMAL,25:Loiter to QLand,26:Course Hold,27:Auto Trim
    // @User: Standard
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Bitmask: 21: Switch to FBWA at the end of a TAKEOFF mode climb instead of loitering at TKOFF_DIST (fork)
