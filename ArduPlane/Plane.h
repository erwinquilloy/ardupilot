...
#include <AP_Radar/AP_Radar.h>                 // iNav Radar / FormationFlight peer-aircraft radar
...
#if AP_RADAR_ENABLED
    // iNav Radar / FormationFlight peer-aircraft radar (MSP wire format)
    AP_Radar radar;
#endif
