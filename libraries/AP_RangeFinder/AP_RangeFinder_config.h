...
// TFmini Plus). TFmini Plus is the most popular cheap LIDAR for FPV/wing
// builds; they all share the AP_RangeFinder_Benewake base driver so the
// marginal flash cost of enabling all four is minimal vs enabling just one.
#ifndef AP_RANGEFINDER_BENEWAKE_TF02_ENABLED
#define AP_RANGEFINDER_BENEWAKE_TF02_ENABLED AP_RANGEFINDER_BENEWAKE_ENABLED
#endif

#ifndef AP_RANGEFINDER_BENEWAKE_TF03_ENABLED
#define AP_RANGEFINDER_BENEWAKE_TF03_ENABLED AP_RANGEFINDER_BENEWAKE_ENABLED
#endif

#ifndef AP_RANGEFINDER_BENEWAKE_TFMINI_ENABLED
#define AP_RANGEFINDER_BENEWAKE_TFMINI_ENABLED AP_RANGEFINDER_BENEWAKE_ENABLED
#endif

#ifndef AP_RANGEFINDER_BENEWAKE_TFMINIPLUS_ENABLED
// (see Benewake TF02/TF03/TFmini comment above)
#define AP_RANGEFINDER_BENEWAKE_TFMINIPLUS_ENABLED AP_RANGEFINDER_BENEWAKE_ENABLED
#endif
